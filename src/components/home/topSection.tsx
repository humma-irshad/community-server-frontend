      ...
      <Box display='flex' alignItems='center' marginTop={6}>
        <StyledBox>
          ...
          <Typography paragraph={true} width={'35rem'} variant='subtitle1'>
            IUST Student Community is created to help students to get better grades in their final
            examinations by providing Course lectures, Graded Assignment Solutions, Workshops and
            Internships.
          </Typography>
        </StyledBox>
        <Image
